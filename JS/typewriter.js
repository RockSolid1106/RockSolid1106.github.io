            ...
            const S = function() {
                function n(r, E) {
                    ...
                    N(this, "setupWrapperElement", (function() {
                        ...
                        b.state.elements.cursor.innerHTML = '<span style="color: orange;">_</span>',
                            ...
                            if (!(n <= (r = a.eventName === c || a.eventName === u ? "natural" === b.options.deleteSpeed ? s(40, 80) : b.options.deleteSpeed : "natural" === b.options.delay ? s(120, 160) : b.options.delay))) {
                                ...
                                case f:
                                    var x = a.eventArgs
                                      , P = x.node
                                      , R = x.parentNode;
                                    R ? R.appendChild(P) : b.state.elements.wrapper.appendChild(P),
                                    b.state.visibleNodes = [].concat(T(b.state.visibleNodes), [{
                                        type: g,
                                        node: P,
                ...
                (E = [{
                    ...
                    value: function() {
                        ...
                        !window || window.___TYPEWRITER_JS_STYLES_ADDED___ || this.options.skipAddStyles || (e = ".Typewriter__cursor{-webkit-animation:Typewriter-cursor 1s infinite;animation:Typewriter-cursor 1s infinite;margin-left:1px}@-webkit-keyframes Typewriter-cursor{0%{opacity:0}49%{opacity:0}50%{opacity:1}99%{opacity:1}100%{opacity:0}}@keyframes Typewriter-cursor{0%{opacity:0}49%{opacity:0}50%{opacity:1}99%{opacity:1}100%{opacity:0}}",
